...
const Carousel = ({ images }) => {
  ...
  return (
    <div
      className="relative overflow-hidden w-[98%] h-full border-2 border-solid rounded-lg shadow-xl cursor-pointer mx-auto"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <div className="flex transition-transform duration-500 ease-in-out h-[100%]">
