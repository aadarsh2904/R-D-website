...
const linkhome = () => {
  return (
    <div className="w-full pt-6">
      <h1 className="text-6xl text-center font-semibold text-blue-700 py-8">
        Explore more
      </h1>
     
      <div className="w-full px-4 grid grid-cols-4 gap-6 py-2">
        <button className="bg-blue-700 p-2.5 border-2 border-blue-800 rounded-lg  text-lg text-white font-semibold hover:bg-white hover:text-blue-700 hover:ring-2 ">
          <a href="https://serb.gov.in/index.php/home.php" target="_blank">
            Science and Engineering Research Board
          </a>
        </button>
        <button className="bg-blue-700 p-6 border-2 border-blue-800 rounded-lg  text-lg text-white font-semibold hover:bg-white hover:text-blue-700 hover:ring-2 ">
          <a
