...
const Navbar = () => {
  ...
  const handleDropdown1 = () => {
    setDropdown1((prevDropdown1) =>
      prevDropdown1 === "hidden"
        ? " hover:bg-white hover:text-blue-700 text-center w-full p-3"
        : "hidden"
    );
    setHr1((prevHr1) => (prevHr1 === "hidden" ? " w-full" : "hidden"));
  };
  const handleDropdown2 = () => {
    setDropdown2((prevDropdown2) =>
      prevDropdown2 === "hidden"
        ? " hover:bg-white hover:text-blue-700 text-center w-full p-3"
        : "hidden"
    );
  ...
  const handleDropdown3 = () => {
    setDropdown3((prevDropdown3) =>
      prevDropdown3 === "hidden"
        ? " hover:bg-white hover:text-blue-700 text-center w-full p-3"
        : "hidden"
    );
  ...
  const handleDropdown4 = () => {
    setDropdown4((prevDropdown4) =>
      prevDropdown4 === "hidden"
        ? " hover:bg-white hover:text-blue-700 text-center w-full p-3"
        : "hidden"
    );
      ...
      <div className="absolute top-6 right-3 min-[1241px]:hidden shadow-lg max-w-[50%]">
        <button className="p-1 bg-gray-100 rounded-lg " onClick={handleNavbar}>
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            className="inline-block w-12 h-12 text-blue-900 "
          >
            <path
        ...
        <div className={navbar}>
          ...
          <ul className="flex flex-col  p-0 m-0 w-[18rem] items-center text-lg ">
            ...
            <li className=" hover:bg-white hover:text-blue-700 w-full text-center">
              <div
                className=" justify-center p-3  flex flex-row mx-auto "
            ...
            <li className={dropdown1}>
              <div>
                <a href="https://sic.iiti.ac.in/">SIC </a> {/*SIC*/}
              </div>
            </li>
            <hr className={hr1} />
            <li className={dropdown1}>
              <div>
                <a href="/prius">PRIUS</a> {/*PRIUS*/}
              </div>
            </li>
            <hr className={hr1} />
            <li className={dropdown1}>
              <div>
                <a href="/cep">CEP </a> {/*CEP*/}
              </div>
            </li>
            ...
            <li className={dropdown2}>
              <div>
                <a href="#">YFRSG</a> {/*YFRSG*/}
              </div>
            </li>
            <hr className={hr2} />
            <li className={dropdown2}>
              <div>
                <a href="#">SIPPT </a> {/*SIPPT*/}
              </div>
            </li>
            <hr className={hr2} />
            <li className={dropdown2}>
            ...
            <li className={dropdown3}>
              <div>
                <a href="/projects/sponsored">Sponsored </a> {/*sponsoredr*/}
              </div>
            </li>
            <hr className={hr3} />
            <li className={dropdown3}>
              <div>
                <a href="/projects/consultancy">Consultancy</a> {/*Consultancy*/}
              </div>
            </li>
            <hr className={hr3} />
            <li className={dropdown3}>
            ...
            <li className={dropdown4}>
              <div>
                <a href="/patent">Patents </a> {/*Patent*/}
              </div>
            </li>
            <hr className={hr4} />
            <li className={dropdown4}>
              <div>
                <a href="/Tech_transfer">Tech Transfer</a> {/*Tech transfer*/}
              </div>
            </li>
