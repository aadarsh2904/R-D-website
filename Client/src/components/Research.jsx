...
const Research = () => {
  ...
  return (
    <div className="relative my-10 border-2 border-black pb-14  bg-[url('POD1.jpg')] bg-no-repeat  bg-cover bg-center">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center pb-4 ">
          ...
          <div className="grid grid-cols-7 gap-8 mt-2 ">
            ...
            <div className=" text-center text-2xl font-semibold text-white">Internal</div>
            <div className=" text-center text-2xl font-semibold text-white">Sponsered</div>
            <div className=" text-center text-2xl font-semibold text-white">
              Consultancy
            </div>
            <div className=" text-center text-2xl font-semibold text-white">Others</div>
            <div className=" text-center text-2xl font-semibold text-white">Total</div>
