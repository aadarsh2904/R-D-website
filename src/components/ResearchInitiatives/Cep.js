...
const Cep = () => {
  ...
  return (
    <div className="research-scheme-container-Cep" style={{ marginBottom: '0' }}>
    <h1 className="section-heading-Cep">Continuing Education Programme (CEP)</h1>

    <div className="scheme-details-Cep">
      <p>
