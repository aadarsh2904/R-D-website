    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-center pb-18 mb-16">
        ...
        <div className="flex flex-row flex-wrap justify-center items-center">
          {OFFICE.map((val) => (
            <div key={val.id} className="scale-95 relative w-[375px] overflow-hidden rounded-3xl shadow-lg group bg-white m-8 border border-gray-300 hover:border-blue-500">
