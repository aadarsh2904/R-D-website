...
function Card({ image_url, name, position, id ,email,phone}) {
  return (
    <div class="card">
        <div class="card-info">
        <div class="card-avatar"></div>
        <div class="card-title">{name}</div>
        <div class="card-subtitle">{position}</div>
        <div class="card-subtitle">Email: {email}</div>
        <div class="card-subtitle">Phone: {phone}</div>
        </div>
